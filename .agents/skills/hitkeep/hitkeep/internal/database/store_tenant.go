...
var ErrTeamInviteLoginRequired = errors.New("sign in required to accept team invite")
var ErrTeamInviteEmailMismatch = errors.New("team invite email does not match authenticated user")
