...
MEDUSA_BACKEND_URL = os.environ.get("MEDUSA_BACKEND_URL", "")
MEDUSA_PUBLISHABLE_KEY = os.environ.get("MEDUSA_PUBLISHABLE_KEY", "")
MEDUSA_REGION_ID = os.environ.get("MEDUSA_REGION_ID", "")
MEDUSA_COUNTRY_CODE = os.environ.get("MEDUSA_COUNTRY_CODE", "")
MEDUSA_CURRENCY_CODE = os.environ.get("MEDUSA_CURRENCY_CODE", "")
MEDUSA_ADMIN_API_TOKEN = os.environ.get("MEDUSA_ADMIN_API_TOKEN", "")
MEDUSA_ADMIN_BEARER_TOKEN = os.environ.get("MEDUSA_ADMIN_BEARER_TOKEN", "")
MEDUSA_REQUEST_TIMEOUT_SECONDS = float(
    os.environ.get("MEDUSA_REQUEST_TIMEOUT_SECONDS", "15")
)
MOUHER_STOREFRONT_PRODUCT_LIMIT = os.environ.get("MOUHER_STOREFRONT_PRODUCT_LIMIT", "")
MOUHER_STOREFRONT_PRODUCT_FIELDS = os.environ.get("MOUHER_STOREFRONT_PRODUCT_FIELDS", "")

MOUHER_INTERNAL_API_TOKEN = os.environ.get("MOUHER_INTERNAL_API_TOKEN", "")
MOUHER_PAYMENT_WEBHOOK_SECRET = os.environ.get("MOUHER_PAYMENT_WEBHOOK_SECRET", "")
